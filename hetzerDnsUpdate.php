...
<form class="form-horizontal group-border stripped" action="" method="post">
  ...
  <div class="form-group">
    ...
    <label class="col-lg-2 col-md-3 control-label" for="">API-Token:</label>
      <div class="col-lg-10 col-md-9">
        <input type="text" class="form-control formadd" name="directory" id="directory" maxlength="255" value="<?php if (isset($objConfig) && property_exists($objConfig, 'apiToken')) echo $objConfig->apiToken; ?>">
